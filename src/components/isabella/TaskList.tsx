  ...
  if (tasks.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center text-center p-6 border border-dashed rounded-lg bg-muted/30">
        ...
        <p className="font-medium font-libre-baskerville animate-gradient-subtitle">No reminders yet</p>
        <p className="text-sm font-libre-baskerville animate-gradient-subtitle">Isabella can help you set them up!</p>
      </div>
    );
  }
